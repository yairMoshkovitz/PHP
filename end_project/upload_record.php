...
<br>
<br><div>שיעור: <?php echo $_SESSION["lesson"]; ?></div>
  </div>
  <form action="api.php" method="post" enctype="multipart/form-data" >
<div class= "offset-3 col-md-2" ><input name="add_record" id= "add_record" class="form-control" value= 'true'></div>


  <div class="file-upload">
  <button class="file-upload-btn" type="button" onclick="$('.file-upload-input').trigger( 'click' )">הוסף הקלטה</button>

  <div class="image-upload-wrap">
    <input id ="file" class="file-upload-input" type='file' onchange="readURL(this);" accept="image/*" name="fileToUpload" />
    <div class="drag-text">
      <h3>Drag and drop a file or select add audio file</h3>
    </div>
  </div>
...
<br>
<button id = "back" class="btn btn-default offset-3" type= "submit"><- Back</button>
...
$("#back").click(function(){
    window.location.assign('./upload_lesson.php');
  });
