...
<br>
<br>
<div>נושא: <?php echo $_SESSION["sub"]; ?></div>
  </div>
  <form action="api.php" method="post" enctype="multipart/form-data" >
  <div class= "offset-3 col-md-2"><input name="lesson" id= "lesson" class="form-control" placeholder="שם השיעור"></div>

  <div class="file-upload">
  <button class="file-upload-btn" type="button" onclick="$('.file-upload-input').trigger( 'click' )">הוסף דף מקורות</button>

  <div class="image-upload-wrap">
    <input id ="file" class="file-upload-input" type='file' onchange="readURL(this);" accept="image/*" name="fileToUpload" />
    <div class="drag-text">
      <h3>Drag and drop a file or select add PDF / DOCX</h3>
    </div>
  </div>
